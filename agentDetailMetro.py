...
class agentDetailMetro:
    ...
    def downloadData(dateInicio, dateFinal, pipkinsUser, pipkinsPassword):
        ...
        position = driver.find_element(by=By.XPATH, value='//*[@id="ContentMain_MaintenanceOfficeTransfer_AvailableSelect"]/option[1]')
        driver.execute_script("arguments[0].scrollIntoView();", position)
        time.sleep(4)
        actions = ActionChains(driver)
        optionCol = driver.find_element(by=By.XPATH, value='//*[@id="ContentMain_MaintenanceOfficeTransfer_AvailableSelect"]/option[1]')
        actions.double_click(optionCol).perform()
        time.sleep(4)
        position = driver.find_element(by=By.XPATH, value='//*[@id="ContentMain_MaintenanceStaffGroupTransfer_AvailableSelect"]/option[6]')
        driver.execute_script("arguments[0].scrollIntoView();", position)
        time.sleep(4)
        optionTraining = driver.find_element(by=By.XPATH, value='//*[@id="ContentMain_MaintenanceStaffGroupTransfer_AvailableSelect"]/option[6]')
